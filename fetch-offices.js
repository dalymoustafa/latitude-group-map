...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("latitude group")
  );

  if (!record) { console.error("Could not find Latitude Group!"); process.exit(1); }
...
<head>
  ...
  <title>Latitude Group — Office Locations</title>
